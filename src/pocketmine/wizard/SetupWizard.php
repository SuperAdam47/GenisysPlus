...
class SetupWizard{
	...
	public function run(){
		echo "[*] 正在为GenisysPlus首次运行做准备\n";

		$langs = BaseLang::getLanguageList();
		if(empty($langs)){
			echo "[!] 没有找到语言文件，请联系管理员" . PHP_EOL;
			return false;
		}
  ...
  This program is free software at YongCheng Interconnection: you can redistribute it and/or modify
  it under the terms of the GNU Lesser General Public License as published by
  the Free Software Foundation, either version 3 of the License, or
  (at your option) any later version.

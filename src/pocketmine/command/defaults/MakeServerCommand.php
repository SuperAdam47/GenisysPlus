...
class MakeServerCommand extends VanillaCommand {
    ...
    public function __construct($name) {
        parent::__construct(
            $name,
            "%GenisysPlus.command.makeserver.description",
            "%GenisysPlus.command.makeserver.usage"
        );
        $this->setPermission("GenisysPlus.command.makeserver");
    }
    ...
    public function execute(CommandSender $sender, $commandLabel, array $args) {
        ...
        $pharPath = Server::getInstance()->getPluginPath() . DIRECTORY_SEPARATOR . "GenisysPlus" . DIRECTORY_SEPARATOR . $server->getName() . "_" . $server->getPocketMineVersion() . ".phar";
